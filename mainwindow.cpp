    ...
    , ui(new Ui::MainWindow)
{
    ...
    query.exec("CREATE TABLE produtos_vendidos (id INTEGER PRIMARY KEY AUTOINCREMENT, id_produto INTEGER, quantidade INTEGER, FOREIGN KEY (id_produto) REFERENCES produtos(id))");
    if (query.isActive()) {
